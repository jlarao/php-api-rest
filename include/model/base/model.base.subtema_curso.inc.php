<?php
	...
	class ModeloBaseSubtema_curso extends clsBasicCommon
	{
		...
		var $__s=array("idSubTema","nombreSubTema","idTema","horarioInicio","horarioFin","fechaRegistro","idUsuarioRegistro","estatus");
		var $__ss=array();
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO subtema_curso(nombreSubTema,idTema,horarioInicio,horarioFin,fechaRegistro,idUsuarioRegistro,estatus)
		...
		public function getDatos()
		{
			...
			{
				$SQL="SELECT
						idSubTema,nombreSubTema,idTema,horarioInicio,horarioFin,fechaRegistro,idUsuarioRegistro,estatus
					FROM subtema_curso
					WHERE idSubTema=" . mysqli_real_escape_string($this->dbLink,$this->idSubTema);
