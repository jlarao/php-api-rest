<?php
	...
	class ModeloBaseHerramientas_curso extends clsBasicCommon
	{
		...
		var $__s=array("idHerramientaCurso","nombreHerramienta","idTipoHerramienta","urlHerramienta","formatoHerramienta","idTema","idUsuarioRegistro","fechaRegistro","agregarVideo");
		var $__ss=array();
		...
		public function getDatos()
		{
			...
			{
				$SQL="SELECT
						idHerramientaCurso,nombreHerramienta,idTipoHerramienta,urlHerramienta,formatoHerramienta,idTema,idUsuarioRegistro,fechaRegistro,agregarVideo
